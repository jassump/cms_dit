...
class Navigator extends React.Component {
    ...
    render() {
        ...
        let navOptions = (
            <>
                <li className="rightside logout"><Link to="/" onClick={this.onLogOut}>Sair</Link></li>
                <li className="rightside"><NavLink activeClassName="selected" to="/settings">Opções</NavLink></li>
            </>
        );
        ...
        if (!loggedIn) {
            username = 'Invitado';
            navOptions = (
                <li className="rightside"><Link to="/register">Registrar</Link></li>
            );
        }
            ...
            <nav>
                <div className="full_container">
                    <ul>
                        ...
                        <li><NavLink activeClassName="selected" to="/articles">Notícias</NavLink></li>
